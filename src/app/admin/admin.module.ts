...
@NgModule({
  ...
  providers: [UserRepository, ExternalSystemRepository, SeasonRepository, SeasonMapper, LeagueRepository, LeagueMapper,
    CompetitionRepository, CompetitionMapper, FieldRepository, FieldMapper, RefereeRepository, RefereeMapper,
    AssociationRepository, AssociationMapper,
    StructureRepository, StructureMapper, RoundRepository, RoundMapper, RoundNumberMapper, RoundNumberConfigRepository, RoundNumberConfigMapper,
    RoundNumberConfigScoreMapper, PouleMapper, PoulePlaceRepository, PoulePlaceMapper, CompetitorRepository, CompetitorMapper,
    GameRepository, GameMapper, GamePoulePlaceMapper, GameScoreMapper,
    ExternalObjectRepository, ExternalObjectMapper, BookmakerRepository, ExternalSystemMapper]
})
